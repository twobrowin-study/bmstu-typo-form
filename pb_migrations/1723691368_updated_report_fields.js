...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("l6ryrjtn")

  // remove
  collection.schema.removeField("2v322jiv")

  // remove
  collection.schema.removeField("kfnv2eas")

  // remove
  collection.schema.removeField("9tgmkhon")

  // remove
  collection.schema.removeField("ac2ztswg")

  // remove
  collection.schema.removeField("mlv1ktjc")

  // remove
  collection.schema.removeField("wujkbfhj")

  // remove
  collection.schema.removeField("3prugzl7")
