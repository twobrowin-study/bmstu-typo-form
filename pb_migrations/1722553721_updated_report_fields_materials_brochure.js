...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("dvplsbg4")

  // remove
  collection.schema.removeField("oknlpqlk")

  // remove
  collection.schema.removeField("qvoqzvee")

  // remove
  collection.schema.removeField("pi1imqws")

  // remove
  collection.schema.removeField("e81bcirq")

  // remove
  collection.schema.removeField("cs7qmjpe")

  // remove
  collection.schema.removeField("tqqhv8dp")

  // remove
  collection.schema.removeField("gkwodsz7")
