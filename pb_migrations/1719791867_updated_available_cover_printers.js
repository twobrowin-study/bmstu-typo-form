...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("e3sj5kou")

  // remove
  collection.schema.removeField("0ahm8tni")

  // remove
  collection.schema.removeField("mj233yz7")

  // remove
  collection.schema.removeField("pv6sawpi")

  // remove
  collection.schema.removeField("fgpmppsl")

  // remove
  collection.schema.removeField("xouyjduu")
