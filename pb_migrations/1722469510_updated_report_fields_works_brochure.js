...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("pkf1obza")

  // remove
  collection.schema.removeField("d72ko7c5")

  // remove
  collection.schema.removeField("tvp4tzw0")

  // remove
  collection.schema.removeField("fhlcxkrd")

  // remove
  collection.schema.removeField("zlgqqacy")

  // remove
  collection.schema.removeField("jcun5n7w")

  // remove
  collection.schema.removeField("ejujrpvw")

  // remove
  collection.schema.removeField("lwkixnvk")
  ...
  // remove
  collection.schema.removeField("mu2d9joj")

  // remove
  collection.schema.removeField("c4lcbmky")

  // remove
  collection.schema.removeField("a6y3z0hi")

  // remove
  collection.schema.removeField("k6rce5ld")

  // remove
  collection.schema.removeField("yhq9cxis")

  // remove
  collection.schema.removeField("uw4kpjgb")

  // remove
  collection.schema.removeField("le3ufm45")

  // remove
  collection.schema.removeField("amy9mtfj")
