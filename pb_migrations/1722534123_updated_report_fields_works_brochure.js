...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("dwgkx4df")

  // remove
  collection.schema.removeField("xvs62duo")

  // remove
  collection.schema.removeField("z0jzd3kj")

  // remove
  collection.schema.removeField("eorypwfl")

  // remove
  collection.schema.removeField("v9eylwsi")

  // remove
  collection.schema.removeField("jc3jbsiv")

  // remove
  collection.schema.removeField("0ghxgivu")

  // remove
  collection.schema.removeField("9zszgvj1")
