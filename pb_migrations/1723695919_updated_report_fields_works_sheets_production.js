...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("iu3eys5g")

  // remove
  collection.schema.removeField("znfws4ee")

  // remove
  collection.schema.removeField("7wzjtvyz")

  // remove
  collection.schema.removeField("tucymdzg")

  // remove
  collection.schema.removeField("bd6cjbmd")

  // remove
  collection.schema.removeField("tbyowx8q")

  // remove
  collection.schema.removeField("lfjzaugo")

  // remove
  collection.schema.removeField("2psfpsh5")
