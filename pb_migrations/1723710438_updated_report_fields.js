...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("kgqcwfwk")

  // remove
  collection.schema.removeField("udqlnw1a")

  // remove
  collection.schema.removeField("ntphqgsu")

  // remove
  collection.schema.removeField("khx2tsmt")

  // remove
  collection.schema.removeField("qoyf48fd")

  // remove
  collection.schema.removeField("gxmsi18s")

  // remove
  collection.schema.removeField("dkgaungr")

  // remove
  collection.schema.removeField("u3h7iign")
  ...
  // remove
  collection.schema.removeField("grqqdebw")

  // remove
  collection.schema.removeField("jay0ihbo")

  // remove
  collection.schema.removeField("kkmfrd2s")

  // remove
  collection.schema.removeField("try6v4gh")

  // remove
  collection.schema.removeField("vwp1uiqr")

  // remove
  collection.schema.removeField("0ailql0w")

  // remove
  collection.schema.removeField("tdrviwr3")

  // remove
  collection.schema.removeField("qcfpfvpa")
