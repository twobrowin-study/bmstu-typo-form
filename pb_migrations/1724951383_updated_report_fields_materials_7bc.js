...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("hfehu4yo")

  // remove
  collection.schema.removeField("mfpwwoow")

  // remove
  collection.schema.removeField("gsr0obo3")

  // remove
  collection.schema.removeField("kyaljqpz")

  // remove
  collection.schema.removeField("pod5xpoj")

  // remove
  collection.schema.removeField("mbm7dwbz")

  // remove
  collection.schema.removeField("i32gsdsj")

  // remove
  collection.schema.removeField("ypewl6fr")
