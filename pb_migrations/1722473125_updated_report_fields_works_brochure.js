...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("td4himm9")

  // remove
  collection.schema.removeField("wilbo47k")

  // remove
  collection.schema.removeField("ijimcnco")

  // remove
  collection.schema.removeField("jzxljhnm")

  // remove
  collection.schema.removeField("zpnhssk9")

  // remove
  collection.schema.removeField("uygdmwqv")

  // remove
  collection.schema.removeField("mulq6vza")

  // remove
  collection.schema.removeField("q6xyuuu7")
