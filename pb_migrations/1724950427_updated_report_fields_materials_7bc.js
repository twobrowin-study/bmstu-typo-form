...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("l5m49mus")

  // remove
  collection.schema.removeField("7fneamex")

  // remove
  collection.schema.removeField("sdk7munu")

  // remove
  collection.schema.removeField("sanwuxvm")

  // remove
  collection.schema.removeField("4kjolkwp")

  // remove
  collection.schema.removeField("ma3locgt")

  // remove
  collection.schema.removeField("xy2grcch")

  // remove
  collection.schema.removeField("gxitl17f")
