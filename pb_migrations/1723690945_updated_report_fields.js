...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("zrih5um3")

  // remove
  collection.schema.removeField("4ye1pze5")

  // remove
  collection.schema.removeField("iyer2oma")

  // remove
  collection.schema.removeField("whlmomkb")

  // remove
  collection.schema.removeField("jqsh3vc8")

  // remove
  collection.schema.removeField("99pa7a8u")

  // remove
  collection.schema.removeField("mnnfq5qn")

  // remove
  collection.schema.removeField("b8dde8ly")
