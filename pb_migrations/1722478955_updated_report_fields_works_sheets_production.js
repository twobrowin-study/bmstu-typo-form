...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ya5oegcm")

  // remove
  collection.schema.removeField("noasbkev")

  // remove
  collection.schema.removeField("aiaxsgh0")

  // remove
  collection.schema.removeField("5jl8wgmr")

  // remove
  collection.schema.removeField("kh0occno")

  // remove
  collection.schema.removeField("dmnzjalw")

  // remove
  collection.schema.removeField("ro9wi6vq")

  // remove
  collection.schema.removeField("hmjulwx0")
