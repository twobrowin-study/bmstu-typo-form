...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("4jqb7b7e")

  // remove
  collection.schema.removeField("oh4byekb")

  // remove
  collection.schema.removeField("41okz3t4")

  // remove
  collection.schema.removeField("b8grrjao")

  // remove
  collection.schema.removeField("bhwxfsit")

  // remove
  collection.schema.removeField("zyoe6uwk")

  // remove
  collection.schema.removeField("y1dvog21")

  // remove
  collection.schema.removeField("ef9nmuxi")
  ...
  // remove
  collection.schema.removeField("pdfufjkb")

  // remove
  collection.schema.removeField("p5mdtre5")

  // remove
  collection.schema.removeField("88uw14w1")

  // remove
  collection.schema.removeField("atf5dgd1")

  // remove
  collection.schema.removeField("y9du4bqg")

  // remove
  collection.schema.removeField("nxh9hipl")

  // remove
  collection.schema.removeField("lk0njbtn")

  // remove
  collection.schema.removeField("gu8u4js6")
