...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("7nigamz7")

  // remove
  collection.schema.removeField("v2vqu9nc")

  // remove
  collection.schema.removeField("wzmefh8z")

  // remove
  collection.schema.removeField("zxcxulpe")

  // remove
  collection.schema.removeField("mg3bssas")

  // remove
  collection.schema.removeField("byiztjgh")

  // remove
  collection.schema.removeField("w3ioyoxf")

  // remove
  collection.schema.removeField("tpo3jm7o")
