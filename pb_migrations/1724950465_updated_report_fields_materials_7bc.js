...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("de64u8kh")

  // remove
  collection.schema.removeField("reccpumi")

  // remove
  collection.schema.removeField("1xaztclc")

  // remove
  collection.schema.removeField("ydzvsocp")

  // remove
  collection.schema.removeField("3lp3zre8")

  // remove
  collection.schema.removeField("jz8v5oxn")

  // remove
  collection.schema.removeField("otp8fnv5")

  // remove
  collection.schema.removeField("vixrudmd")
