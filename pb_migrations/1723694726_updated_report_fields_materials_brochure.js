...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ugikiv1n")

  // remove
  collection.schema.removeField("ottwnqu1")

  // remove
  collection.schema.removeField("zpcummqf")

  // remove
  collection.schema.removeField("zgtyctqe")

  // remove
  collection.schema.removeField("tvacgsyi")

  // remove
  collection.schema.removeField("cynjn2vx")

  // remove
  collection.schema.removeField("uucckv3v")

  // remove
  collection.schema.removeField("gm4bznwu")
