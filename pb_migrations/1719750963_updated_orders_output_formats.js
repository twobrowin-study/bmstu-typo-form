...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("m41v90t0")

  // remove
  collection.schema.removeField("tprsext7")

  // remove
  collection.schema.removeField("cjsreaim")

  // remove
  collection.schema.removeField("rxaljhko")
