...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("xnk9v6on")

  // remove
  collection.schema.removeField("r6hwlwix")

  // remove
  collection.schema.removeField("msntnr5x")

  // remove
  collection.schema.removeField("q22mz3xs")

  // remove
  collection.schema.removeField("hvzshsls")

  // remove
  collection.schema.removeField("nwtoh1tk")

  // remove
  collection.schema.removeField("qmqih6l1")

  // remove
  collection.schema.removeField("ji3nflyr")
  ...
  // remove
  collection.schema.removeField("7fmyjwtu")

  // remove
  collection.schema.removeField("2rfmx3uv")

  // remove
  collection.schema.removeField("sfqcfdr1")

  // remove
  collection.schema.removeField("9k8uaoht")

  // remove
  collection.schema.removeField("9ivaz5zn")

  // remove
  collection.schema.removeField("g7yq08gn")

  // remove
  collection.schema.removeField("ondp0ow0")

  // remove
  collection.schema.removeField("payunqaq")
