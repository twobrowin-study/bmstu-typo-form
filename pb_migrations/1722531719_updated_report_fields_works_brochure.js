...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("pualaagq")

  // remove
  collection.schema.removeField("wukezc6y")

  // remove
  collection.schema.removeField("pmc8jl8l")

  // remove
  collection.schema.removeField("41bteq9l")

  // remove
  collection.schema.removeField("kbyzklpn")

  // remove
  collection.schema.removeField("mtipj8gj")

  // remove
  collection.schema.removeField("0gvpyjjz")

  // remove
  collection.schema.removeField("ncmcudty")
