...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("rym8akuy")

  // remove
  collection.schema.removeField("pkcv7zgm")

  // remove
  collection.schema.removeField("zqkmoaro")

  // remove
  collection.schema.removeField("itjdzgjq")

  // remove
  collection.schema.removeField("vstyreo8")

  // remove
  collection.schema.removeField("a1h22dug")

  // remove
  collection.schema.removeField("ti9kzkr1")

  // remove
  collection.schema.removeField("a72uycgh")
  ...
  // remove
  collection.schema.removeField("orrz9kai")

  // remove
  collection.schema.removeField("kggd8wbb")

  // remove
  collection.schema.removeField("6hkuv6vl")

  // remove
  collection.schema.removeField("15mergns")

  // remove
  collection.schema.removeField("5f8fwabs")

  // remove
  collection.schema.removeField("hzp0v7t4")

  // remove
  collection.schema.removeField("howhwqje")

  // remove
  collection.schema.removeField("zdhbqoge")
