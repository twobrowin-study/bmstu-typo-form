...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("tk1sksdf")

  // remove
  collection.schema.removeField("z1rwaacs")

  // remove
  collection.schema.removeField("az5rzsiy")

  // remove
  collection.schema.removeField("mwpep7sq")

  // remove
  collection.schema.removeField("nnqvfcne")

  // remove
  collection.schema.removeField("awadp3bi")
