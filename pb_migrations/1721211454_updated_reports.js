...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("0p04kudf")

  // remove
  collection.schema.removeField("lgexdixi")

  // remove
  collection.schema.removeField("3xluydmk")

  // remove
  collection.schema.removeField("gcp62m4u")

  // remove
  collection.schema.removeField("gxlyfauz")

  // remove
  collection.schema.removeField("hhum9ccu")

  // remove
  collection.schema.removeField("zyohlqbw")

  // remove
  collection.schema.removeField("tmh2xnif")
