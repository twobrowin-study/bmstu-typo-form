...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("kp6cigro")

  // remove
  collection.schema.removeField("kbw3iq5g")

  // remove
  collection.schema.removeField("iqxjioyc")

  // remove
  collection.schema.removeField("gi76wsi0")

  // remove
  collection.schema.removeField("yh7rvk9w")

  // remove
  collection.schema.removeField("oipljraf")

  // remove
  collection.schema.removeField("xhol1iio")

  // remove
  collection.schema.removeField("vvo59pdu")
