...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("9t12bkaz")

  // remove
  collection.schema.removeField("jha8nwdr")

  // remove
  collection.schema.removeField("ogmkhrzd")

  // remove
  collection.schema.removeField("tp2y049t")

  // remove
  collection.schema.removeField("jdk89r9r")

  // remove
  collection.schema.removeField("2s9kowg4")

  // remove
  collection.schema.removeField("a7twmrws")

  // remove
  collection.schema.removeField("qxdnaj4e")
