...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("n7dmcxkj")

  // remove
  collection.schema.removeField("08e4tfid")

  // remove
  collection.schema.removeField("ds3jnixq")

  // remove
  collection.schema.removeField("h8i5wuwt")

  // remove
  collection.schema.removeField("9mhj1ixj")

  // remove
  collection.schema.removeField("fcbv3vl9")

  // remove
  collection.schema.removeField("wevtyra2")

  // remove
  collection.schema.removeField("2ctyq7tu")
