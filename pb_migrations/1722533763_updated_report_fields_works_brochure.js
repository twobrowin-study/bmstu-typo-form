...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("tpgnxgdw")

  // remove
  collection.schema.removeField("dznmpdru")

  // remove
  collection.schema.removeField("rffupo0a")

  // remove
  collection.schema.removeField("vskiix9n")

  // remove
  collection.schema.removeField("iwfizzuq")

  // remove
  collection.schema.removeField("xuxyzqqq")

  // remove
  collection.schema.removeField("xgltj9tv")

  // remove
  collection.schema.removeField("vne1crcr")
