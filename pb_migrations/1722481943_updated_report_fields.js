...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("o0sxmdhc")

  // remove
  collection.schema.removeField("9smn0yjz")

  // remove
  collection.schema.removeField("ff6r60j1")

  // remove
  collection.schema.removeField("3pbvkp49")

  // remove
  collection.schema.removeField("c1patm8e")

  // remove
  collection.schema.removeField("xv6xsecq")

  // remove
  collection.schema.removeField("tesrston")

  // remove
  collection.schema.removeField("9csboqwo")
