...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("8g2cou9s")

  // remove
  collection.schema.removeField("yov4avgg")

  // remove
  collection.schema.removeField("uud7nawa")

  // remove
  collection.schema.removeField("dcv2bu6r")

  // remove
  collection.schema.removeField("4bhm5gzo")

  // remove
  collection.schema.removeField("bmkul9av")
  ...
  // remove
  collection.schema.removeField("abqaefcj")

  // remove
  collection.schema.removeField("y7zlbfli")

  // remove
  collection.schema.removeField("k4cbqwu4")

  // remove
  collection.schema.removeField("u1vcx0cg")

  // remove
  collection.schema.removeField("bqfpb6oq")

  // remove
  collection.schema.removeField("wygorppx")
