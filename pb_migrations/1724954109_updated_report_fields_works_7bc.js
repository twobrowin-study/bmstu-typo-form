...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("gg3gbepl")

  // remove
  collection.schema.removeField("u9h1mzoc")

  // remove
  collection.schema.removeField("jc4hqkoj")

  // remove
  collection.schema.removeField("sum2tyol")

  // remove
  collection.schema.removeField("g02shukv")

  // remove
  collection.schema.removeField("gfnmjjyn")

  // remove
  collection.schema.removeField("hw8nqlwu")

  // remove
  collection.schema.removeField("is6qd6kj")
  ...
  // remove
  collection.schema.removeField("9vtb4itt")

  // remove
  collection.schema.removeField("edcq1oep")

  // remove
  collection.schema.removeField("gh3timzk")

  // remove
  collection.schema.removeField("ngucnbyu")

  // remove
  collection.schema.removeField("che06tl7")

  // remove
  collection.schema.removeField("ap47loqx")

  // remove
  collection.schema.removeField("4b4a37s3")

  // remove
  collection.schema.removeField("nvylukln")
