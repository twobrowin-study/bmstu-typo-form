...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("oqdmmypj")

  // remove
  collection.schema.removeField("ynacgcs0")

  // remove
  collection.schema.removeField("em59itio")

  // remove
  collection.schema.removeField("rspgqa5n")

  // remove
  collection.schema.removeField("ffgfpv0r")

  // remove
  collection.schema.removeField("fynlztjb")

  // remove
  collection.schema.removeField("lg8qorwc")

  // remove
  collection.schema.removeField("eo5f8lzt")
