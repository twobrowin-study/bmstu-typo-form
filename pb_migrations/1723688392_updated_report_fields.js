...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("6yivaast")

  // remove
  collection.schema.removeField("gwqrwrl0")

  // remove
  collection.schema.removeField("geja0nf8")

  // remove
  collection.schema.removeField("siqqtqse")

  // remove
  collection.schema.removeField("akmuodx1")

  // remove
  collection.schema.removeField("ri1e81x3")

  // remove
  collection.schema.removeField("nn3nmq3u")

  // remove
  collection.schema.removeField("luvoextv")
