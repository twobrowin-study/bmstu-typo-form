...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("cgc5okro")

  // remove
  collection.schema.removeField("8uujn3pb")

  // remove
  collection.schema.removeField("eylpcuye")

  // remove
  collection.schema.removeField("9odhiu6r")

  // remove
  collection.schema.removeField("mvlvs08z")

  // remove
  collection.schema.removeField("t27jceav")

  // remove
  collection.schema.removeField("7tjguzze")

  // remove
  collection.schema.removeField("9ls8ep0k")
