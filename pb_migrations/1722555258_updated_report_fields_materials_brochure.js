...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("xv0bkiro")

  // remove
  collection.schema.removeField("cdn2qagx")

  // remove
  collection.schema.removeField("geztvwhv")

  // remove
  collection.schema.removeField("rquhduwl")

  // remove
  collection.schema.removeField("ruavdod7")

  // remove
  collection.schema.removeField("u4aq7l8p")

  // remove
  collection.schema.removeField("zlglal6e")

  // remove
  collection.schema.removeField("ivxx1i6y")
