...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("vkiz39hy")

  // remove
  collection.schema.removeField("lwh2ojjg")

  // remove
  collection.schema.removeField("3y40jbk0")

  // remove
  collection.schema.removeField("vfxradzj")

  // remove
  collection.schema.removeField("l7sf3fd9")

  // remove
  collection.schema.removeField("rcko2rkx")
