...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("vho6ldcl")

  // remove
  collection.schema.removeField("2lobnme5")

  // remove
  collection.schema.removeField("qh0rkdbw")

  // remove
  collection.schema.removeField("rhb7o6py")

  // remove
  collection.schema.removeField("ecxhyfqy")

  // remove
  collection.schema.removeField("neyyxnlh")

  // remove
  collection.schema.removeField("dfenesbi")

  // remove
  collection.schema.removeField("myg9n0md")
