...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("l5oxax1r")

  // remove
  collection.schema.removeField("cfxrftij")

  // remove
  collection.schema.removeField("bxhd3noc")

  // remove
  collection.schema.removeField("xjuj64eq")

  // remove
  collection.schema.removeField("okcxbpel")

  // remove
  collection.schema.removeField("2v2rfxom")

  // remove
  collection.schema.removeField("t5wvie0d")

  // remove
  collection.schema.removeField("rx1b6lhz")
