...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("bcqkbfbm")

  // remove
  collection.schema.removeField("ti80o8uw")

  // remove
  collection.schema.removeField("afbfqccc")

  // remove
  collection.schema.removeField("mse1zbq3")

  // remove
  collection.schema.removeField("mzsyhbdp")

  // remove
  collection.schema.removeField("ckwxoham")
  ...
  // remove
  collection.schema.removeField("oejqr3dd")

  // remove
  collection.schema.removeField("dxdvwa68")

  // remove
  collection.schema.removeField("q0dq6wbt")

  // remove
  collection.schema.removeField("cefk0d0q")

  // remove
  collection.schema.removeField("tltffcyq")

  // remove
  collection.schema.removeField("jjwsw4bf")
