...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("batqrs9o")

  // remove
  collection.schema.removeField("z9o3gjda")

  // remove
  collection.schema.removeField("d0nvpspn")

  // remove
  collection.schema.removeField("8g7j6nmr")

  // remove
  collection.schema.removeField("5acxsawu")

  // remove
  collection.schema.removeField("ewfwuak5")

  // remove
  collection.schema.removeField("wuk1i4ct")

  // remove
  collection.schema.removeField("niv2gch4")
