...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("spsdmxvy")

  // remove
  collection.schema.removeField("mlpk4m4s")

  // remove
  collection.schema.removeField("rjz8pqxa")

  // remove
  collection.schema.removeField("p6uy0klk")

  // remove
  collection.schema.removeField("vcqeaf1s")

  // remove
  collection.schema.removeField("mlotzioa")

  // remove
  collection.schema.removeField("2n73zu9x")

  // remove
  collection.schema.removeField("gltxtqo1")
