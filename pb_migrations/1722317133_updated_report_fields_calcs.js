...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("wnc8cldh")

  // remove
  collection.schema.removeField("ve3qasyx")

  // remove
  collection.schema.removeField("7bbcheu2")

  // remove
  collection.schema.removeField("we2z5v1n")

  // remove
  collection.schema.removeField("9r0oabz5")

  // remove
  collection.schema.removeField("h9dc9ylo")

  // remove
  collection.schema.removeField("euu6ejpo")

  // remove
  collection.schema.removeField("bk0atjre")
