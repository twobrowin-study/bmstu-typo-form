...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("wu0tjvdl")

  // remove
  collection.schema.removeField("0khsmuou")

  // remove
  collection.schema.removeField("wbtuyfyf")

  // remove
  collection.schema.removeField("qgcmj9p5")

  // remove
  collection.schema.removeField("1s2azr4i")

  // remove
  collection.schema.removeField("yo3asvp3")

  // remove
  collection.schema.removeField("c3izxpxg")

  // remove
  collection.schema.removeField("wesptdlx")
