...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("jdhdlxxc")

  // remove
  collection.schema.removeField("kmqekf7b")

  // remove
  collection.schema.removeField("zlm63icf")

  // remove
  collection.schema.removeField("7nr9xswu")

  // remove
  collection.schema.removeField("s9wi9gcu")

  // remove
  collection.schema.removeField("xwnvgmyo")
  ...
  // remove
  collection.schema.removeField("k8dft0fl")

  // remove
  collection.schema.removeField("jqvfpyd8")

  // remove
  collection.schema.removeField("3btqzhj0")

  // remove
  collection.schema.removeField("4bfs1pqq")

  // remove
  collection.schema.removeField("6uxjfs5t")

  // remove
  collection.schema.removeField("r0bludlw")
