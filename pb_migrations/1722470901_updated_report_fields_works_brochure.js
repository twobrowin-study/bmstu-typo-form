...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("m3kd6nxe")

  // remove
  collection.schema.removeField("gvq4es9s")

  // remove
  collection.schema.removeField("bd6lf3gp")

  // remove
  collection.schema.removeField("bqnjhm8j")

  // remove
  collection.schema.removeField("jbvex0un")

  // remove
  collection.schema.removeField("au5bsp92")

  // remove
  collection.schema.removeField("9xd7t1rj")

  // remove
  collection.schema.removeField("ca4gprut")
  ...
  // remove
  collection.schema.removeField("1wswylof")

  // remove
  collection.schema.removeField("v8xtwc3i")

  // remove
  collection.schema.removeField("kkvzwznk")

  // remove
  collection.schema.removeField("orer1vki")

  // remove
  collection.schema.removeField("6lesww64")

  // remove
  collection.schema.removeField("jixwvgm8")

  // remove
  collection.schema.removeField("ruacec5n")

  // remove
  collection.schema.removeField("nddct3j3")
