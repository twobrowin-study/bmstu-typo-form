...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("2ujb4smk")

  // remove
  collection.schema.removeField("wbeadjqx")

  // remove
  collection.schema.removeField("09lb3i8g")

  // remove
  collection.schema.removeField("fgahsbft")

  // remove
  collection.schema.removeField("9slwfk4d")

  // remove
  collection.schema.removeField("jg3knwa7")

  // remove
  collection.schema.removeField("nvtrz0dk")

  // remove
  collection.schema.removeField("v3yhirew")
  ...
  // remove
  collection.schema.removeField("tbb7iffg")

  // remove
  collection.schema.removeField("ehw2aszs")

  // remove
  collection.schema.removeField("lu961yxn")

  // remove
  collection.schema.removeField("qh7tamma")

  // remove
  collection.schema.removeField("pvzj6cgc")

  // remove
  collection.schema.removeField("s0ujvkz1")

  // remove
  collection.schema.removeField("58djjzpa")

  // remove
  collection.schema.removeField("nic97dh2")
