...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("sygqeeew")

  // remove
  collection.schema.removeField("0q9dct96")

  // remove
  collection.schema.removeField("snmoyq72")

  // remove
  collection.schema.removeField("glebl4en")

  // remove
  collection.schema.removeField("dcetnhtz")

  // remove
  collection.schema.removeField("uhydhfev")

  // remove
  collection.schema.removeField("ggksbvgv")

  // remove
  collection.schema.removeField("y3fkuegw")
