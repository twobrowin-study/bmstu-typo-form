...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("h7qn3pud")

  // remove
  collection.schema.removeField("mca2igse")

  // remove
  collection.schema.removeField("kqntrmnb")

  // remove
  collection.schema.removeField("yczxr21q")

  // remove
  collection.schema.removeField("z3ijl93h")

  // remove
  collection.schema.removeField("ufjthmnv")

  // remove
  collection.schema.removeField("7ciythnp")

  // remove
  collection.schema.removeField("j8bs0193")
  ...
  // remove
  collection.schema.removeField("mrqsrv9q")

  // remove
  collection.schema.removeField("rq629bm3")

  // remove
  collection.schema.removeField("bh3llfmb")

  // remove
  collection.schema.removeField("fbuveinw")

  // remove
  collection.schema.removeField("hqoatv5y")

  // remove
  collection.schema.removeField("gfxw0mb2")

  // remove
  collection.schema.removeField("o9o9je8n")

  // remove
  collection.schema.removeField("ido7itc5")
