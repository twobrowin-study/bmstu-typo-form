...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("twhgo2ti")

  // remove
  collection.schema.removeField("8l9ggyip")

  // remove
  collection.schema.removeField("xbtcdebw")

  // remove
  collection.schema.removeField("pxraft8k")

  // remove
  collection.schema.removeField("bbahi5to")

  // remove
  collection.schema.removeField("ihtmthcr")

  // remove
  collection.schema.removeField("ekqtj5os")

  // remove
  collection.schema.removeField("cthaav8r")
  ...
  // remove
  collection.schema.removeField("neizhack")

  // remove
  collection.schema.removeField("0otthzge")

  // remove
  collection.schema.removeField("jtdxwdyu")

  // remove
  collection.schema.removeField("azrhnfmg")

  // remove
  collection.schema.removeField("yftj6fjs")

  // remove
  collection.schema.removeField("1qicyjbq")

  // remove
  collection.schema.removeField("cfojnuin")

  // remove
  collection.schema.removeField("j9u3sgd4")
