...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("flhstl4k")

  // remove
  collection.schema.removeField("eooq3oul")

  // remove
  collection.schema.removeField("zamcer0w")

  // remove
  collection.schema.removeField("am5ngffs")

  // remove
  collection.schema.removeField("wdpmh4q7")

  // remove
  collection.schema.removeField("xsgtwwwf")

  // remove
  collection.schema.removeField("n9cj7u2f")

  // remove
  collection.schema.removeField("vqnqdipw")
