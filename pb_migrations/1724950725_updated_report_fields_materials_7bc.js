...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("i5jb5wqs")

  // remove
  collection.schema.removeField("rj0yhqis")

  // remove
  collection.schema.removeField("f78ovkez")

  // remove
  collection.schema.removeField("bkrheoah")

  // remove
  collection.schema.removeField("lfqhqkap")

  // remove
  collection.schema.removeField("rafduwfc")

  // remove
  collection.schema.removeField("b9cjxhgn")

  // remove
  collection.schema.removeField("c4mh9ibs")
