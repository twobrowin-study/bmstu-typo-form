...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("yiiww2hg")

  // remove
  collection.schema.removeField("ja2cgrs4")

  // remove
  collection.schema.removeField("rwgsngpr")

  // remove
  collection.schema.removeField("trhhewkt")

  // remove
  collection.schema.removeField("cnzbw7f2")

  // remove
  collection.schema.removeField("opg0pkse")

  // remove
  collection.schema.removeField("tjowe1dd")

  // remove
  collection.schema.removeField("p5n85x1z")
