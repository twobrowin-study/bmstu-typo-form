...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("itt4andr")

  // remove
  collection.schema.removeField("qqhvehg7")

  // remove
  collection.schema.removeField("aqby6eh8")

  // remove
  collection.schema.removeField("y35otg9y")

  // remove
  collection.schema.removeField("jjly2kn1")

  // remove
  collection.schema.removeField("t4lbsn8d")

  // remove
  collection.schema.removeField("4fxvpkws")

  // remove
  collection.schema.removeField("exxhpwbp")
  ...
  // remove
  collection.schema.removeField("4ccfrgxg")

  // remove
  collection.schema.removeField("2bcqvdm0")

  // remove
  collection.schema.removeField("kh7xaqrh")

  // remove
  collection.schema.removeField("miuechxa")

  // remove
  collection.schema.removeField("fl04vldd")

  // remove
  collection.schema.removeField("mbzagyvp")

  // remove
  collection.schema.removeField("15yyegoa")

  // remove
  collection.schema.removeField("izwhvi9e")
